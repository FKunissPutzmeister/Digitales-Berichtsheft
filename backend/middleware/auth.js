...
const DEV_USERS = {
  ...
  '00000000-0000-0000-0000-000000000003': { name: 'Florian Kern',        role: 'ausbilder', email: 'florian.kern@putzmeister.com' },
  '00000000-0000-0000-0000-000000000005': { name: 'Lena Müller',         role: 'azubi',     email: 'lena.mueller@putzmeister.com' },
  '00000000-0000-0000-0000-000000000006': { name: 'Jonas Becker',        role: 'azubi',     email: 'jonas.becker@putzmeister.com' },
};
